...
$query_funcionarios = "SELECT COUNT(*) AS total_funcionarios FROM funcionarios";
...
<head>
  ...
  <style>
    ...
    .card-laranja {
      background-color:rgb(117, 69, 20); /* Laranja */
      color: #fff;
    }

    .card-verde {
      background-color:rgb(26, 80, 28); /* Verde */
      color: #fff;
    }
  </style>
</head>
  ...
  <div id="page-content-wrapper" class="content">
    ...
    <div class="container mt-4">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="card p-3 mb-4 card-verde">
